...
import { generateImages, generateSprite, spriteSvg, spriteSvgMove } from '../images';
...
export const watchingResources = (done) => {
    ...
    watch(config.imgSetting.watchSrc, series(parallel(spriteSvg, generateSprite, generateImages), spriteSvgMove, compileSCSS, browserSyncReload));
